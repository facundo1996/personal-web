  ...
  data() {
    return {
      ...
      styled: [
        {
          name: 'Lodash',
          icon: 'https://www.svgrepo.com/show/354007/lodash.svg',
        },
        {
          name: 'jQuery',
      ...
      otherSkills: [
        ...
        {
          name: 'Jira',
          icon: 'https://www.svgrepo.com/show/452241/jira.svg',
        },
        {
          name: 'Trello',
          icon: 'https://www.svgrepo.com/show/475688/trello-color.svg',
        },
        {
          name: 'Figma',
