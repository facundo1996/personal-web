<template>
  <div data-aos="fade-zoom" :data-aos-duration="1000" class="d-flex flex-column justify-content-start align-items-center min-height-page bg-tiquewhite">
    ...
    <div class="container-page d-flex flex-column align-items-center justify-content-start">
      ...
      <div class="form-conatiner">
        ...
        <p class="mb-md-5 mb-2 text-social">Mi email: <b>facundobenedetto2@outlook.com</b></p>
